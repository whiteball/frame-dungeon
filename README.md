...
| --- | --- |
| M | ミニマップ ズーム/全体 切り替え |
| Shift+M | ミニマップ ズーム移動モード 入/出（ズームモード中のみ） |
| Escape | ミニマップ ズーム移動モードから離脱 |
| ミニマップ左クリック | ズーム/全体 切り替え |
| ミニマップ右クリック（ズームモード） | ズーム移動モードに入る |
| ミニマップ右クリック（全体モード） | クリック位置を中心にズーム移動モードに入る（離脱後は全体モードに戻る） |
